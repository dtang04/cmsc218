...
\begin{itemize}
    ...
    \item Each subsequent convolution reduces each dimension by 1 / element
        \begin{itemize}
            \item Given $X \in \mathbb{R}^{n \times \Lambda}$, $X * Y \in \mathbb{R}^{(\Lambda-1) \times (\Lambda-1)}$
        \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item
        \[
            X \odot g = \begin{bmatrix} - x_1 - \\ \vdots \\ - x_n - \end{bmatrix} \begin{bmatrix} g_1 \\ \vdots \\ g_d \end{bmatrix} = \begin{bmatrix} x_{11} \cdot g_1 & x_{12} \cdot g_2 & \ldots & x_{1d} \cdot g_d \\ \vdots & & & \vdots \\ x_{n1} \cdot g_1 & x_{n2} \cdot g_2 & & x_{nd} \cdot g_d \end{bmatrix}
        \]
\end{itemize}
