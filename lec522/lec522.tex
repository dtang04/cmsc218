...
\begin{itemize}
    ...
    \[
        PC_1 = \begin{bmatrix} 0.80 \\ 0.55 \\ 0.12 \\ 0.30\end{bmatrix}
...
\textbf{Notes:}
\begin{itemize}
    \item \textbf{Variance: }  Firstly, determine whether the magnitude of the PC actually reflects the amount of variance for that column.
    \item \textbf{Correlation: }Compare relationships between columns and see if it aligns with the PCs. If \texttt{Age} and \texttt{SpendingScore} followed a negative correlation from the raw
    data, then the PCs should not have the same sign.
\end{itemize}
