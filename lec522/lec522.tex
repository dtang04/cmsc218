...
\textbf{Notes:}
\begin{itemize}
    \item \texttt{Variance: }  Firstly, determine whether the magnitude of the PC actually reflects the amount of variance for that column.
    \item \texttt{Correlation: }Compare relationships between columns and see if it aligns with the PCs. If \texttt{Age} and \texttt{SpendingScore} followed a negative correlation from the raw
